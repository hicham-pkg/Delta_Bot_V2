let handler = async (
  ...
  const sections = [
    {
      ...
      rows: [
        {
          title: "✨ | Welcome",
          description: "Turn group welcome on or off",
          rowId: `${usedPrefix + command} welcome`,
        },
        {
          title: "🌎 | Mode Public",
          description: "becomes public and/or private",
          rowId: `${usedPrefix + command} public`,
        },
        {
          title: "🔗 | Antilink",
          description:
            "activate or deactivate the anti links of whatsapp groups",
          rowId: `${usedPrefix + command} antilink`,
        },
        {
          title: "🔗 | Antilink 2",
          description:
            "activate or deactivate the anti links that start in https",
          rowId: `${usedPrefix + command} antilink2`,
        },
        {
          title: "🔎 | Detect",
          description:
            "activate or deactivate notifications of new modifications in a group",
          rowId: `${usedPrefix + command} detect`,
        },
        {
          title: "❗ | Restrict",
          description:
            "turn restrictions on removing people from groups on or off",
          rowId: `${usedPrefix + command} restrict`,
        },
        {
          title: "☑️ | Autoread",
          description: "Automatically marks conversations as read",
          rowId: `${usedPrefix + command} autoread`,
        },
        {
          title: "🔊 | Audio",
          description: "enable or disable audio commands without prefix",
          rowId: `${usedPrefix + command} audio`,
        },
        {
          title: "👾 | Autosteaker",
          description: "all images, videos or links sent become stickers",
          rowId: `${usedPrefix + command} autosticker`,
        },
        {
          title: "💬 | Pconly",
          description:
            "the bot will only respond to commands if it is a private chat",
          rowId: `${usedPrefix + command} pconly`,
        },
        {
          title: "🏢 | Gconly",
          description:
            "the bot will only respond to commands if it is in group",
          rowId: `${usedPrefix + command} gconly`,
        },
        {
          title: "❌ | Antiviewonce",
          description: "activate or deactivate the anti see only once",
        ...
        {
          title: "💬 | Anti-private",
          description: "the bot will block users who speak to the private",
          rowId: `${usedPrefix + command} antiprivate`,
        },
        {
          title: "🤬 | Antitoxic",
          description: "activate or deactivate the anti bad word",
          rowId: `${usedPrefix + command} antitoxic`,
        },
        {
          title: "🕸️ | Antilock",
          description: "Activates or deactivates the anti-lock",
          rowId: `${usedPrefix + command} antilock`,
        },
        {
          title: "🤖 | ModeJadibot",
          description:
            "enable or disable command for sub bots (#𝚂𝙴𝚁𝙱𝙾𝚃 / #𝙹𝙰𝙳𝙸𝙱𝙾𝚃)",
          rowId: `${usedPrefix + command} modejadibot`,
        },
        {
          title: "👑 | Modeadmin",
          description: "the bot will only respond to group admins",
          rowId: `${usedPrefix + command} modeadmin`,
        },
        {
          title: "😃 | simsimi",
          description:
            "enable or disable the bot to speak in chat using simsimi ai",
          rowId: `${usedPrefix + command} simsimi`,
        },
      ],
    },
  ]
  ...
  conn.sendButton(
    ...
    📣 𝗳𝗼𝗿: ${isAll ? "ᴛʜɪꜱ ʙᴏᴛ" : isUser ? "" : "𝘁𝗵𝗶𝘀 𝗰𝗵𝗮𝘁"}`,
    wm2,
    null,
    [
      [
        `${isEnable ? "✖️ 𝗗𝗲𝗮𝗰𝘁𝗶𝘃𝗮𝘁𝗲 ✖️" : "✔️ 𝗔𝗰𝘁𝗶𝘃𝗮𝘁𝗲 ✔️"}`,
        `${isEnable ? `#disable ${type}` : `#enable ${type}`}`,
      ],
    ],
    m
  )
